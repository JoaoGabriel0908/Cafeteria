...
// EndPoint: Requisição para listar todos os categorias
$app->get('/categoria', function ($request, $response, $args) {

    require_once('../Cmms/modulo/config.php');
    // Import da controller de categorias, que fará a busca de dados
    require_once('../Cmms/controller/controllercategorias.php');

    // Solicita od dados par controle
    if ($dados = listarcategorias()) {
